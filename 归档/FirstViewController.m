...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (([[defaults objectForKey:TYPE_ID] intValue]==2&&[[dic valueForKey:@"IsService"] intValue]>0)||[[dic valueForKey:@"UserName"] isEqualToString:_userName])
    {
        ...
        [[MessageViewController new] loadDataWithType_ID:@"1" andImgName:GET_USER_DEFAUT(IMG_KEY) headView:manageCell.head];
    ...
    {
        self.leftHeadImg = [dic objectForKey:@"HeadImg"];
    }
    userCell.head.image = BACK_IMAGE;
    [[MessageViewController new] loadDataWithType_ID:@"2" andImgName:self.leftHeadImg headView:userCell.head];
